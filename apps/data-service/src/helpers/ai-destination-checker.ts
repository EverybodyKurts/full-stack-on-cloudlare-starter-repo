...
type ObjectSchemaType = z.infer<typeof objectSchema>;
type PageStatus = ObjectSchemaType['pageStatus'];

export async function aiDestinationChecker(env: Env, bodyText: string): Promise<PageStatus> {
